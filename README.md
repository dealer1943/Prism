...
A quiet optical sandbox. Orthographic top-down camera. Light source is always white. Place a laser at any angle; bounce it with mirrors; bend it with prisms. White stays white until it **exits a prism**, then disperses into ROYGBIV (7 beams). The room stays black so beams read as luminous drawings.
...
- **Polish:** Ring aim UI, ROYGBIV dispersion, lab-laser look

## Optics notes

- White laser emits white only.
- On prism **exit**, white splits into ROYGBIV (7 beams) with IOR ≈ 1.514 / 1.520 / 1.528.
